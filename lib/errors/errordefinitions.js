...
var errors = {
  ...
  POCKETEER_DATA_MISMATCH: 'Pocketeer data mismatch',
  POCKETEER_IN_WALLET: 'Pocketeer already in wallet',
  POCKETEER_REGISTERED: 'Pocketeer ID already registered on server',
  POCKETEER_VOTED: 'Pocketeer already voted on this transaction proposal',
  ...
  KEY_IN_POCKETEER: 'Key already registered',
