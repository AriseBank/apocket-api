...
describe('Blockchain monitor', function() {
  ...
  it('should not notify pocketeers of incoming txs more than once', function(done) {
    server.createAddress({}, function(err, address) {
      should.not.exist(err);
  ...
  it('should notify pocketeers of tx confirmation', function(done) {
    server.createAddress({}, function(err, address) {
      should.not.exist(err);
        ...
        setTimeout(function() {
          ...
          setTimeout(function() {
            server.getNotifications({}, function(err, notifications) {
              ...
              n.creatorId.should.equal(server.pocketeerId);
