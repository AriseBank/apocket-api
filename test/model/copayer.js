...
var Pocketeer = require('../../lib/model/pocketeer');


describe('Pocketeer', function() {

  describe('#fromObj', function() {
    it('read a pocketeer', function() {
      var c = Pocketeer.fromObj(testWallet.pocketeers[0]);
      c.name.should.equal('pocketeer 1');
    });
  });
  describe('#createAddress', function() {
    it('should create an address', function() {
      var w = Wallet.fromObj(testWallet);
      var c = Pocketeer.fromObj(testWallet.pocketeers[2]);
